...
<template>
  <div id="app">
    ...
    <div style="text-align: right; margin-bottom: 3rem"> 
      ...
      <b-form @submit.prevent="addTodo" v-show="showForm" class="form">
        <b-form-group>
          <b-form-input v-model.trim="title" type="text" placeholder="Заголовок"></b-form-input>
          <b-form-textarea v-model.trim="description" placeholder="Описание" style="width: 98%; height: 100px; resize: none"></b-form-textarea>
        </b-form-group>
        <b-form-group>
          <b-button type="submit" variant="info" size="lg">Добавить</b-button>
          <b-button @click.prevent="cancel" variant="warning" size="sm">Отмена</b-button>
        </b-form-group>
      </b-form>
